package com.unbelievable.library.implementation.main;
...
public abstract class HeroTabActivity extends BaseActivity implements View.OnClickListener,BaseFragment.OnFragmentInteractionListener{
    ...
    public abstract void addTab(TabManager mTabManager,TabHost mTabHost);
    ...
    public class TabManager implements TabHost.OnTabChangeListener {
        private final HeroTabActivity mActivity;
        // 保存tab
         ...
         */
        public TabManager(HeroTabActivity activity, TabHost tabHost,
                          int containerID) {
            mActivity = activity;
            mTabHost = tabHost;
